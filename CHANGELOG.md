...
* Bump supported rustdoc JSON format version from 57 to 60. (bump `rustdoc-types` from 0.57.3 to 0.60.0)
...
<!-- next-url -->
[Unreleased]: https://github.com/gifnksm/cargo-sync-rdme/compare/v0.5.0...HEAD
