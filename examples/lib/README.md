...
|Method (trait) [^3]|[`Trait::method`](https://gifnksm.github.io/cargo-sync-rdme/cargo_sync_rdme_example_lib/trait.Trait.html#tymethod.method)|[`std::clone::Clone::clone`](https://doc.rust-lang.org/nightly/core/clone/trait.Clone.html#tymethod.clone)|[`num::Num::from_str_radix`](https://docs.rs/num-traits/0.2/num_traits/trait.Num.html#tymethod.from_str_radix)|
...
|Attribute Macro|||[`async_trait::async_trait`](https://docs.rs/async-trait/0.1.58/async_trait/attr.async_trait.html)|
|Derive Macro|||[`serde::Serialize`](https://docs.rs/serde_derive/1.0.145/serde_derive/derive.Serialize.html)|
