...
[`Clone`]: https://doc.rust-lang.org/1.98.0/core/clone/derive.Clone.html "derive core::clone::Clone"
...
[`i32`]: https://doc.rust-lang.org/1.98.0/std/primitive.i32.html "primitive std::i32"
[`function()`]: https://gifnksm.github.io/cargo-sync-rdme/cargo_sync_rdme_example_lib/fn.function.html "fn cargo_sync_rdme_example_lib::function"
[`declarative_macro!`]: https://gifnksm.github.io/cargo-sync-rdme/cargo_sync_rdme_example_lib/macro.declarative_macro.html "macro cargo_sync_rdme_example_lib::declarative_macro"
[`declarative_macro!()`]: https://gifnksm.github.io/cargo-sync-rdme/cargo_sync_rdme_example_lib/macro.declarative_macro.html "macro cargo_sync_rdme_example_lib::declarative_macro"
[declarative_macro!\[\]]: https://gifnksm.github.io/cargo-sync-rdme/cargo_sync_rdme_example_lib/macro.declarative_macro.html "macro cargo_sync_rdme_example_lib::declarative_macro"
...
[`std`]: https://doc.rust-lang.org/1.98.0/std/index.html "mod std"
[`std::collections`]: https://doc.rust-lang.org/1.98.0/std/collections/index.html "mod std::collections"
[`num::bigint`]: https://docs.rs/num/0.4/num/bigint/index.html "mod num::bigint"
[`std::collections::HashMap`]: https://doc.rust-lang.org/1.98.0/std/collections/hash/map/struct.HashMap.html "struct std::collections::hash::map::HashMap"
[num::BigInt@1]: https://docs.rs/num-bigint/0.4/num_bigint/bigint/struct.BigInt.html "struct num_bigint::bigint::BigInt"
[`std::range::Range::start`]: https://doc.rust-lang.org/1.98.0/core/range/struct.Range.html#structfield.start "field core::range::Range::start"
...
[`std::cmp::Reverse::0`]: https://doc.rust-lang.org/1.98.0/core/cmp/struct.Reverse.html#structfield.0 "field core::cmp::Reverse::0"
[`std::mem::MaybeUninit`]: https://doc.rust-lang.org/1.98.0/core/mem/maybe_uninit/union.MaybeUninit.html "union core::mem::maybe_uninit::MaybeUninit"
...
[`Option`]: https://doc.rust-lang.org/1.98.0/core/option/enum.Option.html "enum core::option::Option"
...
[`Option::Some`]: https://doc.rust-lang.org/1.98.0/core/option/enum.Option.html#variant.Some "variant core::option::Option::Some"
...
[`Option::Some::0`]: https://doc.rust-lang.org/1.98.0/core/option/enum.Option.html#variant.Some.field.0 "field core::option::Option::Some::0"
...
[`std::fmt::Result`]: https://doc.rust-lang.org/1.98.0/core/fmt/type.Result.html "type core::fmt::Result"
[`num::BigRational`]: https://docs.rs/num-rational/0.4/num_rational/type.BigRational.html "type num_rational::BigRational"
[`Iterator`]: https://doc.rust-lang.org/1.98.0/core/iter/traits/iterator/trait.Iterator.html "trait core::iter::traits::iterator::Iterator"
[`num::Num`]: https://docs.rs/num-traits/0.2/num_traits/trait.Num.html "trait num_traits::Num"
[`Iterator::next`]: https://doc.rust-lang.org/1.98.0/core/iter/traits/iterator/trait.Iterator.html#tymethod.next "method core::iter::traits::iterator::Iterator::next"
...
[`Iterator::size_hint`]: https://doc.rust-lang.org/1.98.0/core/iter/traits/iterator/trait.Iterator.html#tymethod.size_hint "method core::iter::traits::iterator::Iterator::size_hint"
...
[`FromIterator::from_iter`]: https://doc.rust-lang.org/1.98.0/core/iter/traits/collect/trait.FromIterator.html#tymethod.from_iter "method core::iter::traits::collect::FromIterator::from_iter"
...
[`std::iter::Step::forward`]: https://doc.rust-lang.org/1.98.0/core/iter/range/trait.Step.html#tymethod.forward "method core::iter::range::Step::forward"
...
[`Iterator::Item`]: https://doc.rust-lang.org/1.98.0/core/iter/traits/iterator/trait.Iterator.html#associatedtype.Item "associated type core::iter::traits::iterator::Iterator::Item"
...
[`Vec::clone`]: https://doc.rust-lang.org/1.98.0/alloc/vec/struct.Vec.html#method.clone "method alloc::vec::Vec::clone"
...
[`std::slice::Iter::size_hint`]: https://doc.rust-lang.org/1.98.0/core/slice/iter/struct.Iter.html#method.size_hint "method core::slice::iter::Iter::size_hint"
...
[`Vec::from_iter`]: https://doc.rust-lang.org/1.98.0/alloc/vec/struct.Vec.html#method.from_iter "method alloc::vec::Vec::from_iter"
...
[`std::slice::Iter::Item`]: https://doc.rust-lang.org/1.98.0/core/slice/iter/struct.Iter.html#associatedtype.Item "associated type core::slice::iter::Iter::Item"
...
[`Vec::len`]: https://doc.rust-lang.org/1.98.0/alloc/vec/struct.Vec.html#method.len "method alloc::vec::Vec::len"
...
[`Vec::new`]: https://doc.rust-lang.org/1.98.0/alloc/vec/struct.Vec.html#method.new "method alloc::vec::Vec::new"
...
[`std::time::Duration::ZERO`]: https://doc.rust-lang.org/1.98.0/core/time/struct.Duration.html#associatedconstant.ZERO "associated constant core::time::Duration::ZERO"
...
[`std::path::MAIN_SEPARATOR`]: https://doc.rust-lang.org/1.98.0/std/path/constant.MAIN_SEPARATOR.html "constant std::path::MAIN_SEPARATOR"
[`std::iter::from_fn`]: https://doc.rust-lang.org/1.98.0/core/iter/sources/from_fn/fn.from_fn.html "fn core::iter::sources::from_fn::from_fn"
[`num::abs`]: https://docs.rs/num-traits/0.2/num_traits/sign/fn.abs.html "fn num_traits::sign::abs"
[`i32::count_ones`]: https://doc.rust-lang.org/1.98.0/std/primitive.i32.html#method.count_ones "method std::i32::count_ones"
[`i32::from_str_radix`]: https://doc.rust-lang.org/1.98.0/std/primitive.i32.html#method.from_str_radix "method std::i32::from_str_radix"
[`i32::MAX`]: https://doc.rust-lang.org/1.98.0/std/primitive.i32.html#associatedconstant.MAX "associated constant std::i32::MAX"
[`println`]: https://doc.rust-lang.org/1.98.0/std/macro.println.html "macro std::println"
[`derive`]: https://doc.rust-lang.org/1.98.0/core/macros/builtin/attr.derive.html "attr core::macros::builtin::derive"
